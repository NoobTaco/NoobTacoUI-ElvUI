...
-   NoobTacoUI install now respects your choice for Aura Bar or Icons while in the ElvUI installation. If you would like to change at any time, just re-run the ElvUI install and choose the option you want.
...
-   Cleaned up target debuffs.
-   Cleaned up player debuffs.
