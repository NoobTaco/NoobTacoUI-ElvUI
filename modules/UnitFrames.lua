...
if E.version > 3 then
    ...
    function NoobTacoUI:SetupLayout()
        ...
        E.db["unitframe"]["units"]["focus"]["customTexts"]["TargetLevel"]["text_format"] =
        ...
        E.db["unitframe"]["units"]["raid3"]["rdebuffs"]["font"] = "Exo2-Bold"
        ...
        E.db["unitframe"]["units"]["raid1"]["name"]["xOffset"] = 0
        E.db["unitframe"]["units"]["raid1"]["name"]["yOffset"] = 10
        E.db["unitframe"]["units"]["raid1"]["height"] = 50
    ...
    function NoobTacoUI:SetupUnitFrames(layout, wowver)
        ...
        if layout == 'v1' then
            ...
            E.db["unitframe"]["units"]["raid1"]["buffIndicator"]["size"] = 8
            E.db["unitframe"]["units"]["raid1"]["debuffs"]["sizeOverride"] = 18
            E.db["unitframe"]["units"]["raid1"]["debuffs"]["xOffset"] = 0
            E.db["unitframe"]["units"]["raid1"]["debuffs"]["yOffset"] = -40
            ...
            E.db["movers"]["ElvUF_Raid3Mover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,4,262"
            E.db["movers"]["ElvUF_Raid1Mover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,4,262"
        ...
        elseif layout == 'v2' then
            ...
            E.db["unitframe"]["units"]["raid1"]["name"]["text_format"] =
                "[name:veryshort] [difficultycolor][smartlevel]"
            E.db["unitframe"]["units"]["raid1"]["name"]["yOffset"] = 10
            E.db["unitframe"]["units"]["raid1"]["power"]["height"] = 10
            E.db["unitframe"]["units"]["raid1"]["power"]["position"] = "RIGHT"
            E.db["unitframe"]["units"]["raid1"]["power"]["yOffset"] = 0
