...
function NoobTacoUIElv:UnitframePlayer()
    ...
    E.db["unitframe"]["units"]["player"]["castbar"]["customTextFont"]["font"] = "Poppins-SemiBold"
    ...
    E.db["unitframe"]["units"]["player"]["customTexts"]["PlayerName"]["fontOutline"] = "SHADOW"
    E.db["unitframe"]["units"]["player"]["customTexts"]["PlayerName"]["justifyH"] = "LEFT"
    E.db["unitframe"]["units"]["player"]["customTexts"]["PlayerName"]["size"] = 16
    ...
    E.db["unitframe"]["units"]["player"]["customTexts"]["PlayerName"]["yOffset"] = -10
