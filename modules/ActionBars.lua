...
function NoobTacoUI:SetupActionBars()
    ...
    -- Right Actionbar Cluster - BottomRight (Bar 5)
    ...
    -- Top Actionbar - BottomLeft (Bar 6)
    ...
    -- Extra Action Button
    E.db["actionbar"]["extraActionButton"]["hotkeyFont"] = "Poppins-SemiBold"
